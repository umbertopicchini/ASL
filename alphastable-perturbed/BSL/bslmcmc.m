function MCMC= bslmcmc(problem,thetastart,data,covariates,numsim,R_mcmc,cov_current,burnin,length_CoVupdate,mcwm)
...
loglik_old = feval([problem, '_synlik'],theta_old,sobs,covariates,nobs,numsim);
