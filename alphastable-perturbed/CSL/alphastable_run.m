...
Haario_burnin = 200;
chains_withHaario = cslmcmc(problem,thetatilde_start,y,covariates,numsim,Haario_mcmciter,Haario_proposal,Haario_burnin,Haario_length_CoVupdate,numgroups,mcwm);
