...
numattempts = 1;
numgroups = 20; % numgroups must be such that mod(numsim,numgroups)==0
...
for attempt= 1:numattempts
    ...
    [chains,proposal_cov] = aslmcmc(bigtheta_start,parmask,parbase,s_obs,nobs,nbin,numsim,mcmciter,sd_randomwalk,burnin,numgroups,shrinkage,shrink_param,forgetting,verbose,expandcov);
